    ...
    <div class="card">
        <li>
            <header class="card-header">
                <a class="card-header-title icon-text" :href="'#' + hrefUrl"
                ...
                <button class="card-header-icon  right-icon" aria-label="more options" @click="isOpenChild = !isOpenChild"
                    v-if="item.children">
...
onMounted(() => {
    ...
    // console.log("hrefUrl", $route.path, hrefUrl.value)
