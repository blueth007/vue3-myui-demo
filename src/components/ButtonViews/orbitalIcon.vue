<template>
    <div class="orbital-icon-container">
        <div class="wrapper">
        ...
        & .icon {
            ...
            &.icon5 {
                ...
                & .rocket {
                    ...
                    & .body {
                        ...
                        height: 90%;
                        border-color: transparent;
                        animation: icon5body calc($animationtime / 10) ease infinite;
                ...
                & .line {
                    ...
                    &.left {
                        ...
                        top: 60%;
                        left: 4%;
                        animation: icon5line1 calc($animationtime / 10) ease infinite reverse;
                    ...
                    &.mid {
                        ...
                        top: 50%;
                        left: 5.5%;
                        animation: icon5line2 calc($animationtime / 10) ease infinite;
                    ...
                    &.right {
                        ...
                        top: 80%;
                        left: 17%;
                        animation: icon5line3 calc($animationtime / 10) ease 1s infinite reverse;
            ...
            &.icon8 {
                ...
                & .moon {
                    &.top {
                        ...
                        height: 8%;
                        overflow: visible;
                        animation: icon8moontop calc($animationtime / 2) linear 0s infinite;
            ...
            &.icon9 {
                ...
                & .planetoid {
                    ...
                    &:after {
                        ...
                        animation: icon9planetoid $animationtime ease calc($animationtime / 2) infinite;
                    }
                }
            ...
            &.icon12 {
                ...
                & .planet {
                    ...
                    width: 65%;
                    height: 65%;
                    animation: icon12planet calc($animationtime / 10) linear infinite alternate;
                ...
                & .line {
                    ...
                    &.line1 {
                        ...
                        left: 22%;
                        width: 30%;
                        animation: icon12line1 calc($animationtime / 10) ease infinite alternate;
                    }
                    ...
                    &.line2 {
                        ...
                        left: 25%;
                        width: 20%;
                        animation: icon12line2 calc($animationtime / 10) ease infinite alternate;
                    ...
                    &.line3 {
                        ...
                        left: 42%;
                        width: 20%;
                        animation: icon12line3 calc($animationtime / 10) ease infinite alternate;
                    ...
                    &.line4 {
                        ...
                        left: 55%;
                        width: 50%;
                        animation: icon12line4 calc($animationtime / 10) ease infinite alternate;
                    ...
                    &.line5 {
                        ...
                        left: 65%;
                        width: 50%;
                        animation: icon12line5 calc($animationtime / 10) ease infinite alternate;
                    }
                }
            ...
            &.icon13 {
                ...
                & .square {
                    ...
                    &:before {
                        ...
                        @include bordered();
                        border-color: $gold $gold transparent transparent;
                        animation: icon13click calc($animationtime / 2)ease infinite alternate;
                    }
                }
