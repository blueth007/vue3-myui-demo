<template>
    <div class="cube-plus-container">
        <div class="cube active_item">
            <div class="plus">
                <div class="plus-horizontal" style="background-color: rgb(255, 255, 255); width: 30px;"></div>
                <div class="plus-vertical" style="background-color: rgb(255, 255, 255); height: 30px;"></div>
            </div>
            <div class="quadrant">
                <div class="quadrant__item ">
                    <div class="quadrant__item__content">
                        <svg enable-background="new 0 0 32 32" height="26px" id="Layer_1" version="1.0" viewBox="0 0 32 32"
                ...
                <div class="quadrant__item  ">
                    <div class="quadrant__item__content">
                        <svg enable-background="new 0 0 32 32" height="28px" id="Layer_1" version="1.0" viewBox="0 0 32 32"
                            width="28px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" class="arrow-right"
                            style="opacity: 0; transform: matrix(1, 0, 0, 1, -10, 0);">
                            <path
    ...
    .cube:hover {
        ...
        .quadrant__item {
            ...
            svg {
                ...
                transition: all 0.6s 0.3s ease-in-out forwards;
            }
        }
