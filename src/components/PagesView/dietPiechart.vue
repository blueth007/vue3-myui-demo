...
// https://codepen.io/rgg/pen/pbaJgL
/**
 * 
 * <!DOCTYPE html>
<html>
...
.goldenbox__content__list__item:nth-child(1),
.goldenbox__content__list__item:nth-child(2) {
    margin-bottom: 1em;
}
...
.svg-chart_info_marker[data-active='donut'] {
    background-image: radial-gradient(#35b8cc 38%, #ffffff 45%, #ffffff 64%, rgba(0, 0, 0, 0) 70%);
}

.svg-chart_info_marker[data-active='watermelon'] {
    background-image: radial-gradient(#e8548a 38%, #ffffff 45%, #ffffff 64%, rgba(0, 0, 0, 0) 70%);
}

.svg-chart_info_marker[data-active='sushi'] {
    background-image: radial-gradient(#ff6f69 38%, #ffffff 45%, #ffffff 64%, rgba(0, 0, 0, 0) 70%);
}

.svg-chart_info_marker[data-active='orange'] {
    background-image: radial-gradient(#ff9d4f 38%, #ffffff 45%, #ffffff 64%, rgba(0, 0, 0, 0) 70%);
}
...
.svg-chart_info_marker[data-active='kiwi'] {
    background-image: radial-gradient(#97db94 38%, #ffffff 45%, #ffffff 64%, rgba(0, 0, 0, 0) 70%);
}
...
<body>
 <svg width="128px" height="127px" viewbox="0 0 128 127" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="icon hidden">
    ...
    <main class="flex-pos">
      ...
      <p class="credits color-white"> Crafted with the Dribbbler:</p>
      <p><a class="color-night" href='https://dribbble.com/LauraOcana' title='Lauras profile at Dribbble' target='_blank'>Laura Ocaña</a>
    </main>
    <script>
